    ...
    <UCard class="w-full">
      ...
      <UForm :schema="schema" :state="state" class="space-y-6" @submit="onSubmit">
        ...
        <div class="flex justify-end gap-4 pt-4 border-t border-gray-800">
          <UButton to="/Blog/BlogPostsUi" color="gray" variant="ghost" size="lg">Скасувати</UButton>
...
const { data: postData } = await useFetch<any>(`http://127.0.0.1:8000/api/admin/blog/posts/${postId}`)
