<template>
  <div class="container mx-auto px-4 py-8 max-w-3xl">
    <div class="mb-6">
      <NuxtLink to="/Blog/BlogPostsUi" class="text-sm text-primary-400 hover:text-primary-300 flex items-center gap-2 transition-colors">
        ← Назад до списку
      </NuxtLink>
    </div>
...
const { data: response, status } = await useFetch<any>(`http://127.0.0.1:8000/api/admin/blog/posts/${postId}`);
